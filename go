...
apt install unzip -y
cd /usr/local/bin
wget https://github.com/storj/storj/releases/download/v1.70.2/storagenode_linux_amd64.zip
wget https://github.com/storj/storj/releases/download/v1.70.2/storagenode-updater_linux_amd64.zip
