...
apt install unzip -y
cd /usr/local/bin
wget https://github.com/storj/storj/releases/download/v1.74.1/storagenode_linux_amd64.zip
wget https://github.com/storj/storj/releases/download/v1.74.1/storagenode-updater_linux_amd64.zip
